...
3. **Confidence is computed.** Confidence values come from deterministic formulas over evidence counts. The LLM never declares its own confidence. → [`concerns/cognitive-stack.md`](docs/architecture/concerns/cognitive-stack.md)
