...
108 | 108_agent_turns_claim_lease.sql | fase 1: claim atomico, lease e fencing do turno — heartbeat_at + CHECK do trio de posse (claimed_by/claim_token/lease_expires_at) em agent_turns (issue 504); 109 foi reservado para esta issue e NAO usado — as colunas de claim ja existiam desde a 097
