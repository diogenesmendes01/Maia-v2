...
d('#510 FI-01/FI-02/FI-03 — ingresso, crash pré-enqueue e enfileiramento duplicado', () => {
  ...
  // FI-01
  // ─────────────────────────────────────────────────────────────────────────
  it('FI-01 — o MESMO evento em duas réplicas de processo: um ingresso, um turno lógico', async () => {
    ...
    await estavelDurante(async () => (await driver.ingressosDoEvento(alvo.whatsapp_id)).length, {
  ...
  // FI-02
  // ─────────────────────────────────────────────────────────────────────────
  it('FI-02 — SIGKILL entre o commit e o enqueue: o turno não se perde e o recovery rearma UM job', async () => {
    ...
    await estavelDurante(
      async () => (await driver.jobsDoTurno({ turn_id, mensagem_id: ids.mensagem_id })).length,
      {
    ...
    const jobs = await driver.esperarJobs({ turn_id, mensagem_id: ids.mensagem_id }, 1, {
  ...
  // FI-03
  // ─────────────────────────────────────────────────────────────────────────
  it('FI-03 — o mesmo turn_id enfileirado por N processos: um job ativo, um claim', async () => {
