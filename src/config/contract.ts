...
export const ENV_CONTRACT = {
  ...
  ANTHROPIC_API_KEY: {
    ...
    requiredWhen: 'LLM_PROVIDER=anthropic',
    restartRequired: true,
  },
  OPENROUTER_API_KEY: {
    ...
    requiredWhen: 'LLM_PROVIDER=openrouter',
    restartRequired: true,
  },
  ...
  OPENAI_API_KEY: {
    ...
    requiredWhen: 'EMBEDDING_PROVIDER=openai ou FEATURE_OUTBOUND_VOICE=true',
    restartRequired: true,
  },
  WHISPER_PROVIDER: {
  ...
  VOYAGE_API_KEY: {
    ...
    requiredWhen: 'EMBEDDING_PROVIDER=voyage',
    restartRequired: true,
  },
  COHERE_API_KEY: {
    name: 'COHERE_API_KEY',
    ...
    requiredWhen: 'EMBEDDING_PROVIDER=cohere',
    restartRequired: true,
  },
  ...
  MAIA_STAGING_KEYRING: {
    ...
    requiredWhen: 'MAIA_CHANNEL_ROUTING_MODE=strict',
    restartRequired: true,
    commentedInExample: true,
  },
  ...
  SMTP_HOST: {
    ...
    requiredWhen: 'ALERT_CHANNELS contém email',
    restartRequired: true,
    commentedInExample: true,
  },
  SMTP_PORT: {
  ...
  TELEGRAM_BOT_TOKEN: {
    ...
    requiredWhen: 'ALERT_CHANNELS contém telegram',
    restartRequired: true,
    commentedInExample: true,
  },
  TELEGRAM_CHAT_ID: {
  ...
  BACKUP_S3_ACCESS_KEY: {
    ...
    requiredWhen: 'BACKUP_S3_BUCKET definido',
    restartRequired: true,
    commentedInExample: true,
  },
  ...
  RUNTIME_TRACE_DEBUG_AES_KEY: {
    ...
    requiredWhen: 'RUNTIME_TRACE_DEBUG_S3_BUCKET definido',
    restartRequired: true,
    commentedInExample: true,
  },
  ...
  ADMIN_UI_DEV_LOGIN_TOKEN: {
    ...
    requiredWhen: 'ALLOW_DEV_AUTH=true',
    restartRequired: true,
    commentedInExample: true,
  },
  OIDC_ISSUER: {
