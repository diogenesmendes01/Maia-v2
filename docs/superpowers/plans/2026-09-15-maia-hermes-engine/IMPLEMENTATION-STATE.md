...
- **Linha canônica:** `claude/mh-integracao-c57` (worktree `.claude/worktrees/mh-integracao-c57`),
  integrada LOCALMENTE e NÃO publicada (C57).
- **Etapa:** **P04 (controle humano)**, em andamento. P00–P03 concluídos; as fatias de
  contrato/política de P05, P06 e P07 integradas localmente, com vereditos inalterados (PARCIAIS).
- **Unidades fechadas por último:** `U-C57` (integração local), `U-C27` (fixture conforme K-19, guarda
  reforçada depois da revisão) e a correção do ledger de migrations (C63).
