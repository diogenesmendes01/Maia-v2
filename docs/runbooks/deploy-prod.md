...
os repassa ao processo dele (`npm run release:migrate`), aguardando sua saída
limpa. Se o Coolify desistir do deploy no meio da migration (timeout,
redeploy), o migrator recebe o sinal e pode sair limpamente (liberando o
