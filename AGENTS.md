...
25 subdirectories in [`src/`](src/), one doc each under [`docs/architecture/modules/`](docs/architecture/modules/). See the **Code map** in [`ARCHITECTURE.md`](ARCHITECTURE.md#5-code-map) for the table.
